...
const Login = () => {
  ...
  return (
    <div className='min-h-[80vh] flex items-center justify-center px-4'>
        <form onSubmit={onSubmitHandler} className='flex flex-col gap-3 items-start p-8 min-w-85 sm:min-w-96 rounded-xl text-[#5E5E5E] text-sm shadow-lg bg-white'>
            ...
            <button type='button' onClick={() => window.location.href = '/'} className='text-[#5f6fff] underline cursor-pointer mt-2'>Back to Home</button>
        </form>
    </div>
  )
}
